...
<div class="bg-white" id="sidebar-wrapper">
        <div class="sidebar-heading text-center  border-bottom">
                ...
                <i class="fas fa-book" style="margin-right:10px"></i>Thư Viện Không gian chuyển đổi số Xã Hòa Liên</a></div>
                <div class="list-group list-group-flush my-3">
                        ...
                        <div class="dropdown dropright">
                                ...
                                <?php if (Auth::isAdmin() || Auth::isKyThuat()) { ?>
                                        ...
                                        <i class="fas fa-book-reader" style="margin-right:10px"></i>Đọc giả</a>
                                        <?php } ?>
                                        <?php if (Auth::isAdmin()|| Auth::isKyThuat()) { ?>
